...
class text_detection(object):
    def __init__(self):
        ...
        self.network.load_model(os.path.join(model_path))
    ...
    def __download_model(self, path):
        model_url = 'https://drive.google.com/uc?export=download&id=1Ny4GpbL-NM-NnNKb7bUeOd-IeuqYLLZZ'
        model_name = 'textsnake'
